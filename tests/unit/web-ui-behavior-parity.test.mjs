...
test('captured bundled app skeleton only exposes expected data key drift versus parity baseline', () => {
    ...
    allowedExtraCurrentKeys.push(
        ...
        'pluginsRequestedId',
        'svnLogBrowserUrl',
        'svnLogBrowserUsername',
        'svnLogBrowserPassword',
        'svnLogBrowserRemember',
        'svnLogBrowserPageSizeInput',
        'svnLogBrowserPathFilter',
        'svnLogBrowserKeyword',
        'svnLogBrowserPage',
        'svnLogBrowserItemsRaw',
        'svnLogBrowserHasMore',
        'svnLogBrowserLoading',
        'svnLogBrowserError',
        'svnLogBrowserInfo',
        'svnLogBrowserCacheHit',
        'sessionConverting'
    );
