...
module.exports = async function testSessions(ctx) {
    ...
    // ========== Trash Session Tests ==========
    const deleteResult = await api('trash-session', { source: 'codex', sessionId });
    ...
    const deleteCloneResult = await api('trash-session', { source: 'codex', sessionId: cloneSessionId });
    ...
    const deleteClaudeResult = await api('trash-session', { source: 'claude', sessionId: claudeSessionId });
    ...
    const deleteIndexlessClaudeResult = await api('trash-session', {
        source: 'claude',
    ...
    const deleteLongResult = await api('trash-session', { source: 'codex', sessionId: longSessionId });
    ...
    const staleTrashFilePath = path.join(trashFilesDir, staleTrashFileName);
    ...
    Object.assign(ctx, { cloneSessionId, longSessionId, longMessageCount });
};
