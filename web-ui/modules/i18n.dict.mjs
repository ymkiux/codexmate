const DICT = Object.freeze({
    zh: {
        ...
        'side.tools': '工具',
        'side.svn.meta': 'WebDAV 日志',
        'side.svn.hint': 'PROPFIND/REPORT',
        ...
        'subtitle.svn': '浏览 SVN WebDAV 日志（PROPFIND/REPORT），支持分页、缓存与路径过滤。',
        ...
        'plugins.svnLogBrowser.title': 'SVN 日志浏览器',
        'plugins.svnLogBrowser.remember': '记住凭证（localStorage）',
        'plugins.svnLogBrowser.fields.url': 'URL',
        'plugins.svnLogBrowser.fields.username': '用户名',
        'plugins.svnLogBrowser.fields.password': '密码',
        'plugins.svnLogBrowser.fields.pageSize': '每页',
        'plugins.svnLogBrowser.fields.pathFilter': '路径过滤',
        'plugins.svnLogBrowser.placeholders.url': 'https://example.com/svn/repo/trunk',
        'plugins.svnLogBrowser.placeholders.username': '可留空',
        'plugins.svnLogBrowser.placeholders.password': '可留空',
        'plugins.svnLogBrowser.placeholders.pathFilter': '留空则不过滤（当前页过滤）',
        'plugins.svnLogBrowser.placeholders.search': '当前页搜索：revision / author / message / path',
        'plugins.svnLogBrowser.hints.pathFilter': '仅影响当前页展示，不影响后端查询范围。',
        'plugins.svnLogBrowser.config.title': '配置',
        'plugins.svnLogBrowser.config.badge': '分页与过滤',
        'plugins.svnLogBrowser.actions.load': '获取日志',
        'plugins.svnLogBrowser.actions.clear': '清空',
        'plugins.svnLogBrowser.info.title': '仓库信息',
        'plugins.svnLogBrowser.cache.hit': '缓存：命中',
        'plugins.svnLogBrowser.cache.miss': '缓存：未命中',
        'plugins.svnLogBrowser.empty': '暂无数据',
        'plugins.svnLogBrowser.errors.invalidUrl': 'URL 无效（仅支持 http/https）',
        'plugins.svnLogBrowser.page': '第 {page} 页',
        'plugins.svnLogBrowser.total': '共 {total} 条',
        'plugins.svnLogBrowser.launch.intro': '该插件为独立服务：运行于 3000 端口。先在插件目录安装依赖并启动，然后可在下方内嵌窗口或新标签页使用。',
        'plugins.svnLogBrowser.launch.open': '打开 SVN 日志浏览器',
        'plugins.svnLogBrowser.launch.command': 'cd plugins/svn-log-browser && npm install --no-audit --no-fund && npm start',
    ...
    en: {
        ...
        'subtitle.svn': 'Browse SVN WebDAV logs (PROPFIND/REPORT) with paging, caching, and path filters.',
        ...
        'plugins.svnLogBrowser.title': 'SVN log browser',
        'plugins.svnLogBrowser.remember': 'Remember credentials (localStorage)',
        'plugins.svnLogBrowser.fields.url': 'URL',
        'plugins.svnLogBrowser.fields.username': 'Username',
        'plugins.svnLogBrowser.fields.password': 'Password',
        'plugins.svnLogBrowser.fields.pageSize': 'Per page',
        'plugins.svnLogBrowser.fields.pathFilter': 'Path filter',
        'plugins.svnLogBrowser.placeholders.url': 'https://example.com/svn/repo/trunk',
        'plugins.svnLogBrowser.placeholders.username': 'Optional',
        'plugins.svnLogBrowser.placeholders.password': 'Optional',
        'plugins.svnLogBrowser.placeholders.pathFilter': 'Optional (filters current page only)',
        'plugins.svnLogBrowser.placeholders.search': 'Search this page: revision / author / message / path',
        'plugins.svnLogBrowser.hints.pathFilter': 'Filters current page only; does not change backend query scope.',
        'plugins.svnLogBrowser.config.title': 'Config',
        'plugins.svnLogBrowser.config.badge': 'Paging & filters',
        'plugins.svnLogBrowser.actions.load': 'Load logs',
        'plugins.svnLogBrowser.actions.clear': 'Clear',
        'plugins.svnLogBrowser.info.title': 'Repository info',
        'plugins.svnLogBrowser.cache.hit': 'Cache: hit',
        'plugins.svnLogBrowser.cache.miss': 'Cache: miss',
        'plugins.svnLogBrowser.empty': 'No data',
        'plugins.svnLogBrowser.errors.invalidUrl': 'Invalid URL (http/https only)',
        'plugins.svnLogBrowser.page': 'Page {page}',
        'plugins.svnLogBrowser.total': 'Total {total}',
        'plugins.svnLogBrowser.launch.intro': 'This plugin runs as a standalone service on port 3000. Install dependencies and start it, then use the embedded view or open it in a new tab.',
        'plugins.svnLogBrowser.launch.open': 'Open SVN log browser',
        'plugins.svnLogBrowser.launch.command': 'cd plugins/svn-log-browser && npm install --no-audit --no-fund && npm start',
