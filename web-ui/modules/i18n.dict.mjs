const DICT = Object.freeze({
    zh: {
        ...
        'sessions.preview.clone': '生成派生会话',
        'sessions.preview.cloning': '生成中...',
        'sessions.preview.cloneTitle': '复制当前 Codex 会话并生成新的派生会话',
    ...
    en: {
        ...
        'sessions.preview.clone': 'Create derived',
        'sessions.preview.cloning': 'Creating...',
        'sessions.preview.cloneTitle': 'Copy the current Codex session into a new derived session',
