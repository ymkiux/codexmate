    ...
    const app = createApp({
        data() {
            return {
                ...
                svnLogBrowserRemember: false,
                svnLogBrowserPageSizeInput: '25',
                svnLogBrowserPathFilter: '',
                svnLogBrowserKeyword: '',
                svnLogBrowserPage: 1,
                svnLogBrowserItemsRaw: [],
                svnLogBrowserHasMore: false,
                svnLogBrowserLoading: false,
                svnLogBrowserError: '',
                svnLogBrowserInfo: null,
                svnLogBrowserCacheHit: null,
